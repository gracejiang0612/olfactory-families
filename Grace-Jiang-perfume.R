...
perfume_data <- read_csv("/Users/Grace/Desktop/2025-studio/project-1/GraceJiang-perfume.csv")
...
ggplot(df_long, aes(x = x, 
  ...
  labs(
    title = "Floral and Citrus Families Dominate My Fragrance Wardrobe",
    subtitle = "A Sankey Diagram of Fragrance Families in My Personal Perfume Collection",
